...
export default function DashboardEmptyStateActions({ bookingLink }: Props) {
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
      <Link href="/dashboard/quotes" className="inline-flex items-center justify-center rounded-lg border bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground">Create your first quote</Link>
      {bookingLink ? (
