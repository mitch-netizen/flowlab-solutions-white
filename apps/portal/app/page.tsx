      ...
      <section className="hero-grid">
        <div className="rounded-lg border bg-card p-4">
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            <Link href="/login" className="inline-flex items-center justify-center rounded-lg border bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground">
              Operator login
            </Link>
            <Link href="/enquiry" className="inline-flex items-center justify-center rounded-lg border bg-secondary/40 px-4 py-2 text-sm font-semibold">
              Open enquiry form
            </Link>
          </div>
        </div>
